...
export const clinicUsersMock: ClinicUser[] = [
  ...
  createClinicUser({
    id: "usr-009",
    fullName: "Chaiwat Identity Service",
    initials: "IS",
    employeeId: "SYS-0001",
    email: "identity.service@nexsure.health",
  ...
  createClinicUser({
    id: "usr-010",
    fullName: "Orn Compliance",
    initials: "OC",
    employeeId: "EMP-1218",
    email: "orn.c@nexsure.health",
    jobTitle: "Compliance Officer",
    primaryRole: "auditor_compliance",
    additionalRoles: ["compliance_officer"],
  ...
  createClinicUser({
    id: "usr-011",
    fullName: "Krit Executive",
    initials: "KE",
    employeeId: "EMP-1301",
    email: "krit.e@nexsure.health",
